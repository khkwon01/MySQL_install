...
export MOS_LINK_SRV_TAR='https://updates.oracle.com/Orion/Services/download/p36788062_100_Linux-x86-64.zip?aru=25735531&patch_file=p36788062_100_Linux-x86-64.zip'
export MOS_LINK_SHELL_TAR='https://updates.oracle.com/Orion/Services/download/p36790169_100_Linux-x86-64.zip?aru=25736438&patch_file=p36790169_100_Linux-x86-64.zip'
export DEV_LINK_SRV_TAR='https://dev.mysql.com/get/Downloads/MySQL-9.0/mysql-9.0.0-linux-glibc2.17-x86_64.tar.xz'
export DEV_LINK_SHELL_TAR='https://dev.mysql.com/get/Downloads/MySQL-Shell/mysql-shell-9.0.0-1.el8.x86_64.rpm'
export CHK_DL_MYSQL="${sw_dir}/mysql_download_type.lst"
export PUBLIC_ReleaseNote='https://dev.mysql.com/doc/relnotes/mysql/9.0/en/news-9-0-0.html'
