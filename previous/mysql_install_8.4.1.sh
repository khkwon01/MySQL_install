...
export MOS_LINK_SRV_TAR='https://updates.oracle.com/Orion/Services/download/p36788700_840_Linux-x86-64.zip?aru=25735873&patch_file=p36788700_840_Linux-x86-64.zip'
...
export DEV_LINK_SRV_TAR='https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-8.4.1-linux-glibc2.17-x86_64.tar.xz'
...
export PUBLIC_ReleaseNote='https://dev.mysql.com/doc/relnotes/mysql/8.4/en/news-8-4-1.html'
